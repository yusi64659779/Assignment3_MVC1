...
namespace Assignment3_F19.Controllers
{
    public class VegetablesController : Controller
    {
        ...
        {
            var vegetables = db.Vegetables.Include(v => v.AgriProduct);
        ...
        {
            ViewBag.Product_ID = new SelectList(db.AgriProducts, "Product_ID", "Product_Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Veg_ID,Product_ID,Veg_Name")] Vegetable vegetable)
        {
            ...
            ViewBag.Product_ID = new SelectList(db.AgriProducts, "Product_ID", "Product_Name", vegetable.Product_ID);
            return View(vegetable);
        }
